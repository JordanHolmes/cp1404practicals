...
def format_into_sentence(phrase):
    """
    Format a given phrase into a sentece, starting with a capital and ending with a full stop.
    >>> format_into_sentence("hello")
    'Hello.'
    >>> format_into_sentence("It is an ex parrot")
    'It is an ex parrot.'
    >>> format_into_sentence("quick brown fox jumps over the lazy dog")
