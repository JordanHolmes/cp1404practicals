...
# Used a list comprehension to create a list of integers from this list of strings
numbers = [int(number) for number in almost_numbers]
print(numbers)

# Used a list comprehension to create a list of all of the full_names in lowercase format
